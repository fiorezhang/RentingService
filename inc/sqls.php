<?php
 /**
 * sqls.php LA1Q:e0723cd5ffb145d7b340f227d728a2bd2180
 * Created by yichaxin.com V190612_0123551NJ
 * @author yujianyue<admin@ewuyi.net>
 * Date: 190612@5cffe3ac0a680_12391.net 
 * 注意;著作权所有,不得公开发布和出售
 */
class ConnectMysqli{
//私有的属性
...
$this->user = $config['user'] ? $config['user'] : 'root'; //数据库账号
$this->pass = $config['pass'] ? $config['pass'] : 'SHUTA'; //数据库密码
$this->db = $config['name'] ? $config['name'] : 'RENTING'; //数据库名称
...
return $list;
 ...
 //sqls.php?t=190612@5cffe3ac0a680&m=e0723cd5ffb145d7b340f227d728a2bd 
?>
